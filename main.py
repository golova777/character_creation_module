"""Это учебный модуль
Здесь несколько функций со своим смыслом"""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция атака. Все параметнры обязательны."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция защита. Все параметнры обязательны."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция специального умения. Все параметнры обязательны."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция начала тренировки. Все параметнры обязательны."""
    if char_class == 'warrior':
